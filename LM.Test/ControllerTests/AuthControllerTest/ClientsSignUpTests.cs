...
{
    public class ClientsSignUpTests
    {
        private readonly AuthControllerFactory _fac;

        public ClientsSignUpTests()
        {
            _fac = new AuthControllerFactory();
        }

        [Fact]
        public async Task ClientsSignUp_ModelUserExistCase()
        {
            // Arrange
            ...
            // Act
            var result = await _fac.AuthController.ClientsSignUp(bookDto) as OkObjectResult;
        ...
        [Fact]
        public async Task ClientsSignUp_ModelValidCase_CreatAsyncFailed()
        {
            // Arrange
            var userId = TestData.UserId;
            ...
            // Act
            var result = await _fac.AuthController.ClientsSignUp(user) as OkObjectResult;
        ...
        [Fact]
        public async Task ClientsSignUp_ModelValidCase_CreatAsyncPassed_RoleExistTrue()
        {
            // Arrange
            var userId = TestData.UserId;
        ...
        [Fact]
        public async Task ClientsSignUp_ModelValidCase_CreatAsyncPassed_RoleExistFalse()
        {
            // Arrange
            var userId = TestData.UserId;
